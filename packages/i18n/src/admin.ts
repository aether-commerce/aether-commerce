...
export const adminDictionaries = {
  en: {
    ...
    chat: {
      ...
      signInRequired: "Sign in to use {brand} Chat.",
      permissionRequired: "You don't have permission to use {brand} Chat.",
  ...
  es: {
    ...
    chat: {
      ...
      signInRequired: "Inicia sesión para usar el chat de {brand}.",
      permissionRequired: "No tienes permisos para usar el chat de {brand}.",
